...
# [V2 修正] 將本次編譯的時間戳記寫入臨時檔，供主控腳本讀取
echo "$builtdate" > "$SCRIPT_DIR/last_builtdate_userdebug.tmp"
...
directory="/mnt/data_1/server/thorpe_A15_testbuild"
;;
*)
...
mail_title=[Thorpe_A15][daily_build_${builtdate}][$BRANCH][$BUILD_VARIANT][GMS]
