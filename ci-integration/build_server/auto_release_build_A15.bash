...
build_code () {
	...
	cd ${directory}/shell-script
    bash build_all_A15.bash thorpe $version -gs 2>&1 | tee buildlog.txt; chk_error $? "Execute build_all.sh failed"
...
upload_image () {
    ...
    expect -c "
        set timeout 2400
        spawn scp -r ${directory}/shell-script/artifact/${zipfile} nick_chuang@10.192.188.16:/media/share/thorpe/Android_15/Release_pega/REL_02.02.01.260331/userdebug
        expect \"password:\"
        send \"${password}\r\"
        expect eof"
