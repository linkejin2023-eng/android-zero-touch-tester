...
branch="release/T70-A15-2.2.0-GMS"
#branch="thorpe_dev_lcd_rotate"
builtdate="02.02.01.260331"
manifest_name="T70-A15-2.2.1-GMS"
...
sync_code () {
    ...
    cd ${directory};repo forall -c 'pwd;git pull pandora release/T70-A15-2.2.0-GMS:release/T70-A15-2.2.0-GMS' 2>&1 | tee pull.log; cd -
	cd ${directory}/QCM6490_apps_qssi15/LINUX/android/.repo/manifests;git reset --hard; git clean -fd; git pull 2>&1 | tee pull.log; cd -
	cd ${directory}/QCM6490_apps_qssi15/LINUX/android;repo forall -c 'pwd;git pull pandora release/T70-A15-2.2.0-GMS:release/T70-A15-2.2.0-GMS' 2>&1 | tee pull.log; cd -
}
...
upload_image () {
    ...
    expect -c "
        set timeout 2400
        spawn scp -r ${directory}/shell-script/artifact/${zipfile} nick_chuang@10.192.188.16:/media/share/thorpe/Android_15/Release_pega/REL_02.02.01.260331/user
        expect \"password:\"
        send \"${password}\r\"
        expect eof"
...
auto_tag () {
    cd ${directory}; dailytag=T70-A15-2.2.1-GMS-FORK
...
#mail
success_content='Done building targets. \\\10.192.188.16\share\\thorpe\Android_15\Release_pega\REL_02.02.02.260411 \n '
mail_title=[Thorpe_A15][release_build_REL_${builtdate}][$branch][GMS]
