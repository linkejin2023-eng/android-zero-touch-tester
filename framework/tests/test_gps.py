        ...
        if "GPS Antenna Signal" not in excluded:
            ...
            if sv_count > 0:
                reporter.add_result("GPS", "GPS Antenna Signal", True, 
                                    f"Hardware OK (Weak Signal Tolerance). Detected {sv_count} satellites.",
            ...
            reporter.add_result("GPS", "GPS Antenna Signal", True, "Skipped by profile", status_override="SKIP")
